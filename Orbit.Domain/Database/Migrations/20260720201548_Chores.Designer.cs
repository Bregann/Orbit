...
namespace Orbit.Domain.Database.Migrations
{
    ...
    [Migration("20260720201548_Chores")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.Asset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.AssetCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.Chore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.FitbitData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("DistanceWalkedMiles")
                    ...
                    b.ToTable("FitbitData");
                });

            modelBuilder.Entity("Orbit.Domain.Database.Models.GoCardlessBankConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("GoCardlessBankConnections");
                });
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.MealPlanEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.Recipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.RecipeCookHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("RecipeCookHistory");
                });

            modelBuilder.Entity("Orbit.Domain.Database.Models.RecipeIngredient", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.RecipeStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.Asset", b =>
                {
                    b.HasOne("Orbit.Domain.Database.Models.AssetCategory", "AssetCategory")
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("Orbit.Domain.Database.Models.MealPlanEntry", b =>
                {
                    b.HasOne("Orbit.Domain.Database.Models.Recipe", "Recipe")
