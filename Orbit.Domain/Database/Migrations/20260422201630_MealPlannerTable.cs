...
{
    /// <inheritdoc />
    public partial class MealPlannerTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeCookHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeCookHistory_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeCookHistory_RecipeId",
                table: "RecipeCookHistory",
                column: "RecipeId");
