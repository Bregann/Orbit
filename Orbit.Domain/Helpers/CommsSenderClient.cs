...
namespace Orbit.Domain.Helpers
{
    ...
    {
        private readonly string _baseAddress = "http://CommsSenderApi:8080";
        private readonly string _apiKey = environmentalSettingHelper.GetEnvironmentalSettingValue(EnvironmentalSettingEnum.CommsSenderApiKey)
